...
cls
color 07
title  Microsoft Aktivasyonu Hasan Alp Gungor
mode 76, 30
...
echo:
echo:                 Aktivasyon Secenekleri:
echo:
echo:             [1] HWID        ^|  Windows           ^|   Permanent
echo:             [2] KMS38       ^|  Windows           ^|   2038 Yil
echo:             [3] Online KMS  ^|  Windows / Office  ^|    180 Gun
echo:             __________________________________________________      
echo:
echo:             [4] Aktivasyon Statusu
...
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "          " %_Green% "Seceneklerden istediginiz rakami girin [1,2,3,4,5,6,7,0] :"
choice /C:12345670 /N
set _erl=%errorlevel%
...
echo:       ______________________________________________________________
echo:
echo:             [1] Windows Versiyonunu Degistir
echo:
echo:             [2] $OEM$ Klasorune Cikart
echo:             [3] Windows HWID Key Gir
echo:             [4] Aktivasyon Statusu [vbs]
echo:             __________________________________________________      
echo:                                                                     
echo:             [0] Ana Menuye Don
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "           " %_Green% "Seceneklerden istediginiz rakami girin [1,2,3,4,0] :"
choice /C:12340 /N
set _erl=%errorlevel%
...
%eline%
echo Masaustu lokasyonu denetlenemedi, durduruluyor...
echo _____________________________________________________
echo:
call :_color %_Yellow% "Geri donmek icin herhangi bir tusa bas..."
pause >nul
goto Extra
)
...
%eline%
echo $OEM$ Klasoru zaten masaustunde var.
echo _____________________________________________________
echo:
call :_color %_Yellow% "Geri donmek icin herhangi bir tusa bas..."
pause >nul
...
echo:
echo:
echo:                   Masaustundeki $OEM$ Klasorune Cikart           
echo:       ______________________________________________________________
echo:                                                            
echo:             [1] HWID
echo:             [2] KMS38
...
echo:       ______________________________________________________________
echo:  
call :_color2 %_White% "           " %_Green% "Klavyeden Menu secenegini girin:"
choice /C:123450 /N
set _erl=%errorlevel%
...
set "_title=Online KMS Aktivasyonu"
set _gui=
...
echo.       ______________________________________________________________
echo.
echo.              [1] Aktive et - Windows
echo.              [2] Aktive et - Office
echo.              [3] Aktive et - All
echo.
if defined _tskinstalled call :_color2 %_White% "              [4] Otomatik Yenileyici Yukle      " %_Green% "[Yuklendi]"
if defined _oldtsk       call :_color2 %_White% "              [4] Otomatik Yenileyici Yukle     " %_Red% "[Eskiden Yuklendi]"
if not defined _tskinstalled if not defined _oldtsk echo.              [4] Otomatik Yenileyici Yukle
echo.              [5] Uninstall
echo.              _______________________________________________  
echo.
if %_Debug%==0 (
echo.              [6] Hata Ayiklama Modu         [No]
) else (
call :_color2 %_White% "              [6] Hata Ayiklama Modu         " %_Red% "[Yes]"
)
...
if %_Debug% EQU 0 (
  ...
  if not defined _args (echo Bittigi zaman bu pencere kapanicak) else (echo lutfen bekleyin...)
  echo.
...
echo.
call :_color %_Yellow% "Geri donmek icin herhangi bir tusa basin..."
pause >nul
exit /b
)
@exit /b
